...
uint16_t lut[4096];
// Lekker/KS-20 0-400 mapped LUT Parameters
const double a = 0.197898146312;
const double b = -0.00609446727442;
const double c = 988.339974298;
const double d = -2122.0613379;
